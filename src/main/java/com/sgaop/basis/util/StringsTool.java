...
public class StringsTool {
    ...
    public static String brief(String str, int len) {
        if (StringsTool.isBlank(str) || (str.length() + 3) <= len)
            return str;
        int w = len / 2;
        int l = str.length();
    ...
    public static String[] splitIgnoreBlank(String s) {
        return StringsTool.splitIgnoreBlank(s, ",");
    }
    ...
    public static String fillDigit(int d, int width) {
        return StringsTool.alignRight(String.valueOf(d), width, '0');
    }
    ...
    public static String fillHex(int d, int width) {
        return StringsTool.alignRight(Integer.toHexString(d), width, '0');
    }
    ...
    public static String fillBinary(int d, int width) {
        return StringsTool.alignRight(Integer.toBinaryString(d), width, '0');
    }
    ...
    public static String toDigit(int d, int width) {
        return StringsTool.cutRight(String.valueOf(d), width, '0');
    }
    ...
    public static String toHex(int d, int width) {
        return StringsTool.cutRight(Integer.toHexString(d), width, '0');
    }
    ...
    public static String toBinary(int d, int width) {
        return StringsTool.cutRight(Integer.toBinaryString(d), width, '0');
    }
    ...
    public static String cutRight(String s, int width, char c) {
        ...
        if (len == width)
            return s;
        if (len < width)
            return StringsTool.dup(c, width - len) + s;
    ...
    public static String cutLeft(String s, int width, char c) {
        ...
        if (len == width)
            return s;
        if (len < width)
            return s + StringsTool.dup(c, width - len);
    ...
    public static String sBlank(Object obj, String def) {
        ...
        return StringsTool.isBlank(s) ? def : s;
    }
    ...
    public static String removeFirst(String str, char c) {
        return (StringsTool.isEmpty(str) || c != str.charAt(0)) ? str : str.substring(1);
    }
    ...
    public static boolean isin(String[] ss, String s) {
        if (null == ss || ss.length == 0 || StringsTool.isBlank(s))
            return false;
        for (String w : ss)
            if (s.equals(w))
                return true;
